            ...
            <div class="card">
                <form action="personCollection" method="post" class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="firstName" class="form-control" id="firstName${person.id}" value="${person.firstName}">
                    </div>

                    <div class="form-group">
                        <label for="lastName${person.id}">Last name</label>
                        <input type="text" name="lastName" class=form-control id="lastName${person.id}" value="${person.lastName}">
                    </div>

                    <div class="form-group">
                        <label for="eyeColor${person.id}">Eye color</label>
                        <input type="text" name="eyeColor" class=form-control id="eyeColor${person.id}" value="${person.eyeColor}">
                    </div>
                    <div class="form-group">
                        <label for="hairColor${person.id}">Hair color</label>
                        <input type="text" name="hairColor" class=form-control id="hairColor${person.id}" value="${person.hairColor}">
                    </div>
                    <div class="form-group">
                        <label for="height${person.id}">Height</label>
                        <input type="text" name="height" class=form-control id="height${person.id}" value="${person.height}">
                    </div>
                    <div class="form-group">
                        <label for="weight${person.id}">Weight</label>
                        <input type="text" name="weight" class=form-control id="weight${person.id}" value="${person.weight}">
                    </div>
